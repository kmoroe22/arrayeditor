...
public class FillerTest {
    ...
    public void whenNoNeighboursHaveSameValuesThenFillOnlyAppliesToStartElement() throws PointIsNotWithinArrayException {
        ...
        Assert.assertEquals(newValue, array.valueAt(1, 1), 0);
    ...
    public void whenNeighboursHaveSameValuesThenFillCascadesNewValue() throws PointIsNotWithinArrayException {
        EditableArray array = new EditableArray(new double[][]{{1, 5, 3}, {5, 5, 6}, {7, 8, 9}});
        ...
        Assert.assertEquals(1, array.valueAt(0, 0), 0);
        Assert.assertEquals(newValue, array.valueAt(0, 1), 0);
        Assert.assertEquals(3, array.valueAt(0, 2), 0);

        Assert.assertEquals(newValue, array.valueAt(1, 0), 0);
        Assert.assertEquals(newValue, array.valueAt(1, 1), 0);
        Assert.assertEquals(6, array.valueAt(1, 2), 0);
    ...
    public void whenNeighboursHaveTransientSameValuesThenNewValueCascades() throws PointIsNotWithinArrayException {
        EditableArray array = new EditableArray(new double[][]{{1, 2, 3}, {1, 1, 1}, {7, 8, 1}});
        ...
        Assert.assertEquals(newValue, array.valueAt(0, 0), 0);
        Assert.assertEquals(2, array.valueAt(0, 1), 0);
        Assert.assertEquals(3, array.valueAt(0, 2), 0);

        Assert.assertEquals(newValue, array.valueAt(1, 0), 0);
        Assert.assertEquals(newValue, array.valueAt(1, 1), 0);
        Assert.assertEquals(newValue, array.valueAt(1, 2), 0);

        Assert.assertEquals(7, array.valueAt(2, 0), 0);
        Assert.assertEquals(8, array.valueAt(2, 1), 0);
        Assert.assertEquals(newValue, array.valueAt(2, 2), 0);
    }
    ...
    public void whenNeighboursDoNotHaveMatchingValueButTransientNeighboursDoValueDoesNotCascadeToTransientNeighbours() throws PointIsNotWithinArrayException {
        EditableArray array = new EditableArray(new double[][]{{1, 2, 1}, {4, 1, 6}, {7, 8, 1}});
        ...
        Assert.assertEquals(newValue, array.valueAt(0, 0), 0);
        Assert.assertEquals(2, array.valueAt(0, 1), 0);
        Assert.assertEquals(1, array.valueAt(0, 2), 0);

        Assert.assertEquals(4, array.valueAt(1, 0), 0);
        Assert.assertEquals(1, array.valueAt(1, 1), 0);
        Assert.assertEquals(6, array.valueAt(1, 2), 0);

        Assert.assertEquals(7, array.valueAt(2, 0), 0);
        Assert.assertEquals(8, array.valueAt(2, 1), 0);
        Assert.assertEquals(1, array.valueAt(2, 2), 0);
    }
